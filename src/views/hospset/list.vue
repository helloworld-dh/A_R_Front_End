    ...
    <el-table-column label="操作" width="280" align="center">
        <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.status==0" type="danger" size="mini" 
                icon="el-icon-delete" @click="lockHospSet(scope.row.id,1)">解除锁定</el-button>
...
export default{
    ...
    created() {    //在页面渲染之前执行   一般调用methods定义的方法，得到数据
        this.getList()
    },
